...
public class SimonListViewHeader extends LinearLayout {
	...
	public SimonListViewHeader(Context context) {
		super(context);
		initView(context);
	}

	public SimonListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
