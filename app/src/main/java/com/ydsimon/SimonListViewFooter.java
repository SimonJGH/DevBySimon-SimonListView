...
import com.ydsimon.R;

public class SimonListViewFooter extends LinearLayout {
	...
	public SimonListViewFooter(Context context) {
		super(context);
		initView(context);
	}

	public SimonListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
